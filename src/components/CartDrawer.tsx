              ...
              <>
                ...
                {!isAuthenticated && (
                  <div className="p-3.5 rounded-2xl bg-white border border-stone-200/90 flex items-center justify-between gap-3 text-xs shadow-2xs">
                    <div>
                      <span className="font-heading font-bold text-stone-900 block">Sign In for 1-Tap Delivery</span>
                      <span className="text-[11px] text-stone-500">Auto-fill your address and phone via mobile OTP</span>
                    </div>
                    <button
                      type="button"
